...
### Dice Roller
- Roll any standard dice from **d4 to d20**.
- Roll **multiple dice at once** (up to 3) and see individual results as well as the total sum.
- Keep a **history of the last 5 rolls**.
...
### Timer
- Set a **countdown timer** with minutes and seconds.
